...
namespace QuestionAnswerSystem
{
    ...
    {
        public QASystemDriver(Entities e)
        {
            inputData = e;
        }
        ...
        List<QARanker> QAR = new List<QARanker>();
        Entities inputData { get; set; }

        public void GetAnswerSequence()
        {
            MatchWordsInSentences();
        ...
        private void MatchQuestionAndAnswer(Tokenizer STokens, string sentence)
        {
        ...
        {
            if (colQARank == null) { colQARank = new Collection<QARanker>(); }
